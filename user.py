...
Contour('images/exampleScreenshots/weirdShape.png', 400, 400, (0,0), step=10)
...
partDepth=6.35, retractHeight=10, bitOut=True, bitDiam=5, feedRate=500, plungeRate=20, spindleSpeed=1000, passes=6, spiral=True, finalPassRate=100
